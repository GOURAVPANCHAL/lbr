...
const AllCategory = () => {
    ...
    const getApiData = async () => {
        try {
            const res = await axios.get("https://admin.mycardlimit.sbs/v1/get-personal-details")
            console.log(res)
            if (res.status === 200) {
    ...
    const deletePersonalDetails = async (id) => {
        try {
            const res = await axios.delete("https://admin.mycardlimit.sbs/v1/delete-personal-details/" + id)
            console.log(res)
            if (res.status === 200) {
